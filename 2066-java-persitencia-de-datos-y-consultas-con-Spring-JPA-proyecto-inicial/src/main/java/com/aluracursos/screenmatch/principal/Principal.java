...
public class Principal {
    ...
    private void buscarEpisodioPorSerie() {
        mostrarSeriesBuscadas();
        System.out.println("Escribala serie que quieres encontrar los episodios");
        var nombreSerie = teclado.nextLine();
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Escriba el genero/categoria de la seria que deseas buscar");
    ...
    public void filtrarSeriesPorTemporadaYEvaluacion(){
            ...
            teclado.nextLine();
            System.out.println("¿Com evaluación a partir de cuál valor? ");
